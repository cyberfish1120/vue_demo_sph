...
export default {
    ...
    computed: {
        ...mapState('user', ['myOrderList'])
    },
    methods: {
        getPageNo(page){
          this.$store.dispatch('user/getMyOrderList', {page, limit:this.limit})
        }
    },
    mounted() {
        this.$store.dispatch('user/getMyOrderList', {page:this.page, limit:this.limit})
    },
};
</script>
